...
function createGameView() {
    ...
    for (var row = 0; row < game.heightCellsCount; row++) {
        ...
        var _loop = function _loop(column) {
            ...
            td.onclick = function cellClickHandler() {
                ...
                var currentCellData = game.board.getCell(row, column);
        ...
        for (var column = 0; column < game.widthCellsCount; column++) {
            _loop(column);
        }
...
function draw() {
    ...
    for (var row = 0; row < game.heightCellsCount; row++) {
        for (var column = 0; column < game.widthCellsCount; column++) {
            ...
            updateCellView(_td, game.board.getCell(row, column).isAlive);
        }
    }
}
...
var Game = function () {
    ...
    _createClass(Game, [{
        ...
        key: "run",
        value: function run(callbackOnEachGameStep) {
            var _this = this;
    ...
    _createClass(Board, [{
        ...
        value: function getGridCopy() {
            ...
            for (var row = 0; row < this.heightCellsCount; row++) {
                ...
                for (var column = 0; column < this.widthCellsCount; column++) {
                    currentRowCells.push(Object.assign(new _cell2.default(), this.grid[row][column]));
